...
public sealed class ExtendedRecordInterfaceSourceGenerator : IIncrementalGenerator
{
        ...
        Compilation compilation)
    {
        ...
        foreach (var recordDeclarationSyntax in recordDeclarationSyntaxes)
        {
            ...
            var propertiesWithThis = properties
               .Prepend(new(@interface, "record", false))
               .ToImmutableArray();

            var parameters = CreateOptionalParametersCode(propertiesWithThis, sb);
            sb.Clear();
            ...
            var code =
                $$"""
                  ...
                  {
                      public static {{@interface}} With({{parameters}})
                      {
        ...
        Compilation compilation)
    {
        ...
        var propertiesWithThis = properties
           .Prepend(new(@interface, "@this", false))
           .ToImmutableArray();
        ...
        StringBuilder sb)
    {
        ...
        foreach (var (recordTypeName, extensionsTypeName, _) in recordDeclarationSyntaxes)
        {
            ...
            var propertiesWithThis = properties
               .Prepend(new(extensionsTypeName, "extensions", false))
               .ToImmutableArray();
            ...
            var code =
                $"""
                     ...
                     static extern {@interface} Invoke{recordTypeName}With({parameters});
